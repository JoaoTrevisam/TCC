                ...
                <div class="d-inline">
                    <div class="dropdown d-inline">
                        ...
                        <ul class="dropdown-menu filtro-opcoes" aria-labelledby="filterDropdown">
                            ...
                            <li style="margin-bottom: 10px;"><a class="dropdown-item btn-custom" href="#" onclick="filterStudents('oldest')">Todos os Alunos</a></li>
                        </ul>
                    </div>
                </div>
            </div>
                ...
                <form action="novo_usuario.php" method="POST">
                    ...
                    <div class="card imgholder">
                        ...
                        <div>
                            ...
                            <input type="date" name="data_nasc" id="nasciDate" required>
                        </div>
                        <div>
                        ...
                        <div>
                            ...
                            <input type="text" name="endereco" id="address" required>
                        </div>
                        <div>
                            <label for="frequency">Frequência:</label>
                            <input type="number" name="frequencia" id="frequency" min="2" max="6" required>
                        </div>
                        <div>
                            <label for="objective">Objetivo:</label>
                            <input type="text" name="objetivo" id="Objective" required>
                        </div>
                        <div>
                            <label for="sDate">Data de Início:</label>
                            <input type="date" name="data_inicio" id="inDate" required>
                        </div>  
                        <div>
                        <button type="submit" name="criar_aluno" class="btn btn-success submit">Cadastrar</button>
                        </div>
                    </div>
                </form>
            </div>
